...
class NclusterBoxNoSubfiberMazimization(Algorithm):
    ...
    def run(self, u, observations, timeout):
        ...
        self.experiment_path = f"{current_iteration_folder}/output/{current_experiment}/experiments/nclusterboxnosubfibermaximization.experiment"
        self.log_path = f"{current_iteration_folder}/output/{current_experiment}/logs/nclusterboxnosubfibermaximization.log"
        ...
        command += f"../algorithms/nclusterbox_no_subfiber_maximization/nclusterbox -j8 -m1000 {dataset_path} -o {self.experiment_path}"
