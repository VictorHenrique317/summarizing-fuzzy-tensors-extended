...
class NclusterBoxSac(Algorithm):
    def __init__(self, controller: Controller) -> None:
        super().__init__()
        self.name = "nclusterboxsac"
    ...
    def run(self, u, timeout, boolean_tensor=False, custom_experiment_path=None, custom_log_path=None, 
        ...
        if self.__controller.current_configuration_name == 'school':
            print("skipping...")
            return True
        ...
        self.experiment_path = f"{current_iteration_folder}/output/{current_experiment}/experiments/nclusterboxsac.experiment"
        self.log_path = f"{current_iteration_folder}/output/{current_experiment}/logs/nclusterboxsac.log"
        ...
        command += f"../algorithms/nclusterbox_sac/fiber-input {dataset_path} {tube_dim} | "
        command += f"../algorithms/nclusterbox_sac/nclusterbox -f {dataset_path} -o {self.experiment_path}"
